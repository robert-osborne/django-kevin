...
![Django 1.7.4](http://img.shields.io/badge/Django-1.7.4-brightgreen.svg)
...
A heavily personalized project template for Django 1.7.4 using Postgres for development and production. Ready to deploy on Heroku with a bunch of other goodies.
...
Currently using [Django 1.7.4](https://docs.djangoproject.com/en/1.7/) for the app framework
...
- [django-pipeline 1.4.4.1](http://django-pipeline.readthedocs.org/en/latest/) - CSS and JS compressor and compiler. Also minifies HTML
...
dev.txt
-------
- [Werkzeug 0.10](http://werkzeug.pocoo.org/) - WSGI utility library with powerful debugger
...
- [gunicorn 19.2.0](https://github.com/benoitc/gunicorn) - Production WSGI server with workers
