...
![Django 1.7.6](http://img.shields.io/badge/Django-1.7.6-brightgreen.svg)
...
A heavily personalized project template for Django 1.7.6 using Postgres for development and production. Ready to deploy on Heroku with a bunch of other goodies.
...
Currently using [Django 1.7.6](https://docs.djangoproject.com/en/1.7/) for the app framework
